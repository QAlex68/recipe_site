...
# SECRET_KEY = 'django-insecure-_yat@7e+k1gyy10drva&!lt^m^8sdh42-)d#ercpyt#4pk4ijg'
...
DATABASES = {
    ...
    'default': {
        ...
        'HOST': 'kamaev.mysql.pythonanywhere-services.com',
        'OPTIONS': {
...
# STATIC_URL = '/static/'
# STATICFILES_DIRS = [
#     BASE_DIR / "static",  # Общая папка статических файлов
# ]
# Для продакшена: место для сбора статических файлов
